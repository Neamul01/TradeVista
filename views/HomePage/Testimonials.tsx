...
const TESTIMONIALS = [
  {
    ...
    content: `Exceptional platform! The intuitive interface and real-time analytics have elevated my trading experience. Highly recommended for professionals seeking efficiency and insights.`,
    author: {
      name: 'Sarah Reynolds',
  ...
  },
  {
    ...
    content: `Smart automation and secure transactions make trading seamless. The mobile app is a game-changer. A reliable platform for business growth and financial success.`,
    author: {
  ...
  },
  {
    ...
    content: `Impressive AI-driven analytics! It provides invaluable insights for strategic decision-making. The automated portfolio management ensures a well-balanced and optimized investment approach."`,
    author: {
      name: 'Emily Turner',
